    ...
    >
      <style>{`
        ...
        .mobile-menu {
          ...
          box-shadow: -8px 0 32px rgba(0, 255, 136, 0.1);
        }
        ...
        <>
          ...
          <div className="mobile-menu">
            ...
            <div className="mobile-contact-section">
              <div className="mobile-contact-title">Get in touch</div>
...
export default function Page() {
  ...
  // ✅ Background canvas opacity: OFF only in Graffiti (pattern=0), ON for all other patterns
  const [bgOpacity, setBgOpacity] = useState(0)
  const applyBackgroundForIndex = useCallback((i: number) => {
    setBgOpacity(i === 0 ? 0 : 1)
  }, [])
  ...
  const mainSceneOpacity = phase === "main" ? 1 : 0
    ...
    >
      ...
      >
          ...
          <div style={{ transform: 'scale(0.7)' }}>
            <TerminalTypewriter text={BIO_TEXT} />
          </div>
